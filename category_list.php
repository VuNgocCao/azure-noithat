                                    ...
                                    <ul class="dropdown-menu">
                                        <?php 
                                                ...
                                                // output data of each row
                                                    ...
                                                    {
                                                        echo "<li class='dropdown-menu-list'><a href='category_list.php?cate_id=".$row1['cate_id']."'>".$row1['cate_name']."</a></li>";
                                                    }
                                                }
                                        ?>
                                    </ul>
                        ...
                        // output data of each row
                            while($row = mysqli_fetch_assoc($result)) 
                            {
                                echo'<div class="col-2 item">
                                        <a href="category_list.php?cate_id='.$row['cate_id'].'">
                                                ...
                                                if (mysqli_num_rows($result)) {
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result)) 
                                                    {
                                                        echo "<li class='link-list-category-product'>
                                                                <a href='category_list.php?cate_id=".$row['cate_id']."'>".$row["cate_name"]."</a>
                                                            </li>";
                                                    }
                                                }
                                            ?>
