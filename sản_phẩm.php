...
if(isset($_GET['cate_id'])){
    ...
    $search_cate="And category.cate_id='".$cate_id."'";
}else{
    $search_cate="";
}
$search_price="";
...
$sql_product = "Select * From product INNER JOIN category on product.cate_id=category.cate_id where title like '%".$tukhoa."%' ".$search_price." ".$search_trademark." ".$search_cate."";
    ...
    <div class="fui-container">
        ...
        <div class="row owl-stage-outer">
            ...
            <div style="margin-top: 20px" class="row">
                <div class="col-1"></div>
                <div style="display: flex;margin-left:-30px;"class="col-10">
                    <div class="col-3">
                        ...
                        <div class="row title-category-content">
                            ...
                            <div class="category">
                                <ul class="list-category">
                                    ...
                                    <li class="link-list-category">
                                        <a href="sản_phẩm.php">Sản phẩm <i style="font-size: 12px;float: right;margin-top: 5px;font-weight: 700;" class="ti-angle-down"></i></a>
                                        <ul class="list-category-product">
                                            <?php 
                                                ...
                                                if (mysqli_num_rows($result)) {
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result)) 
                                                    {
                                                        echo "<li class='link-list-category-product'>
                                                                <a href='./sản_phẩm.php?cate_id=".$row['cate_id']."'>".$row["cate_name"]."</a>
                                                            </li>";
                                                    }
                                                }
                                            ?>
                        ...
                        if(mysqli_num_rows($result_product)>0){
                            while($row_product = mysqli_fetch_assoc($result_product)){
                                echo "
                                    <div class='card-all'>
                                        <div class='card'>
                                            <a href='detail_product.php?p_id=".$row_product['product_id']."'>
                                            <img class='img-card' src='".$row_product["thumbnail"]."' alt=''>
                                            <span>".$row_product["title"]."</span>
                                            
                                            </a>
                                            <p>".number_format($row_product["price"],"0",",",".")." đ</p>
                                        </div>
                                    </div>";
                            }
                        }
